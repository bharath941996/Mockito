...
public class TrackControllerTest {
    ...
    @InjectMocks
    private TrackController trackControllerTest;
    ...
    public void setUp(){
        ...
        mockMvc = MockMvcBuilders.standaloneSetup(trackControllerTest).build();
        track = new Track();
        track.setTrackId(26);
        track.setTrackName("Jonny");
        track.setTrackComment("Jenny");
        list = new ArrayList();
        list.add(track);
    }
    ...
    public void saveTrack() throws Exception {
        ...
        System.out.println("sadudiugsadiug");
...
//    }
    ...
    @Test
    public void deleteTrackSuccess() throws Exception, TrackIdNotFoundException {
